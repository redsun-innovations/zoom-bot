...
document.getElementById("join_meeting").addEventListener("click", (e) => {
  ...
  const signature = ZoomMtg.generateSDKSignature({
    ...
    success: function (res) {
      ...
      const joinUrl = "C:/Users/Jefrin/Downloads/zoom-sdk-web-3.10.0 (1).zip/zoom-sdk-web-3.10.0/Local/meeting.html?" + testTool.serialize(meetingConfig);
      console.log(joinUrl);
  ...
  const signature = ZoomMtg.generateSDKSignature({
    ...
    success: function (res) {
      ...
      const joinUrl =
        ...
        "C:/Users/Jefrin/Downloads/zoom-sdk-web-3.10.0 (1).zip/zoom-sdk-web-3.10.0/Local/meeting.html?" +
